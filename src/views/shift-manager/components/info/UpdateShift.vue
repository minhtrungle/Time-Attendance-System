  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      <el-button
        type="danger"
        @click="handleClose"
        :disabled="callingAPI || loadingUpdate"
      >
        Hủy
      </el-button>
      <el-button
        type="primary"
        :loading="callingAPI || loadingUpdate"
...
export default {
  ...
  methods: {
    loadData() {
      this.form.summary = this.shift.summary || "";
      this.form.started_at = this.shift.started_at.split(":00.000")[0] || "";
      this.form.ended_at = this.shift.ended_at.split(":00.000")[0] || "";
      this.form.part_time = this.shift.part_time || false;
    },
    handleUpdateShift() {
